...
class AOrderView extends BaseView<AOrderViewController> {
      ...
      children: [
        ...
        Expanded(
          child: controller.listOrder.isEmpty
              ? Center(
                  child: AText.listItem('You have no bill'),
                )
              : ListView.separated(
        ...
        child: Row(
          children: [
            ...
            Column(
              ...
              children: [
                AText.listItem('Status: ${model.status.title}'),
                // AText.body('Thời gian đặt: ${model.createDate}'),
                AText.body('Total: ${model.totalPrice}', color: AColor.red),
              ],
            )
          ],
        ),
  ...
  AppBar? appBar(BuildContext context) {
    return AAppbar(title: 'Payment list');
  }
}
